...
const WORKSPACE_SECRET = process.env.INT_APP_WORKSPACE_SECRET!;
...
export function makeIntegrationToken({
    ...
    const opts: jwt.SignOptions = {
        ...
        expiresIn: 60 * 60 * 2,
        algorithm: "HS512", // match your key type (ES256, RS256, …)
    };

    return jwt.sign(payload, WORKSPACE_SECRET, opts);
}
